package com.example.flux.adapter.out.storage;

import com.example.flux.adapter.out.storage.exception.FileStorageException;
...
public class S3FileStorage implements FileStorage {
    ...
    public InputStream getFileAsStream(String bucketName, String objectKey) {
